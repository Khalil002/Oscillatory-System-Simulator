...
public class Lab_BlasBarreraMachacon_KhalilElHageKassem_MiguelSierraArroyo extends PApplet {
...
public void page3(){
  ...
  A= PApplet.parseFloat(t[0]);
  m= PApplet.parseFloat(t[1]);
  k= PApplet.parseFloat(t[2]);
  a= PApplet.parseFloat(t[3])*PI/180;
  F= PApplet.parseFloat(t[5]);
  wd= PApplet.parseFloat(t[6]);
  w= sqrt(k/m);
  ...
  switch(type){
    ...
    case 0:
      ...
      for(int i=0; i<mat.length; i++){
        ...
        j+=0.01666666666666666666666666666667f;
      }
    break;
    
    //En el caso 1, se selecciona el sistema amortiguado
    case 1:
      float b= PApplet.parseFloat(t[4]);
      float e=2.71828f;
...
class Button{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Lab_BlasBarreraMachacon_KhalilElHageKassem_MiguelSierraArroyo" };
    if (passedArgs != null) {
